...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleException(NoSuchElementException e) {
        GlobalExceptionHandler.log.error("NoSuchElementException: {}", e.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleException(ConstraintViolationException e) {
        GlobalExceptionHandler.log.error("ConstraintViolationException: {}", e.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleException(IllegalArgumentException e) {
        GlobalExceptionHandler.log.error("IllegalArgumentException: {}", e.getMessage());
        return ResponseEntity.badRequest().body(
                Map.of("message", e.getMessage())
        );
    }
    ...
    public ResponseEntity<Map<String, String>>handleValidationErrors(MethodArgumentNotValidException ex) {
        GlobalExceptionHandler.log.error("MethodArgumentNotValidException: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleException(Exception e) {
        GlobalExceptionHandler.log.error("Exception: {}", e.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleAccessDeniedException(final AccessDeniedException e) {
        GlobalExceptionHandler.log.error("AccessDeniedException: {}", e.getMessage());
